 ...
 */
export function getKeyPriceMicroUsdc(supply: number): number {
  return Math.floor(getKeyPrice(supply) * 1_000_000);
}
 ...
 */
export function getBuyCostMicroUsdc(supply: number, quantity: number): number {
  return Math.floor(getBuyCost(supply, quantity) * 1_000_000);
}
 ...
 */
export function getSellPayoutMicroUsdc(supply: number, quantity: number): number {
  return Math.floor(getSellPayout(supply, quantity) * 1_000_000);
}
 ...
 */
export function getAverageBuyPrice(supply: number, quantity: number): number {
  if (quantity <= 0) {
    return 0;
  }
 ...
 * @returns Average price per key in USDC
 */
export function getAverageSellPrice(supply: number, quantity: number): number {
  if (quantity <= 0) {
    return 0;
  }
