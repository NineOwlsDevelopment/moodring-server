...
export const LoginModal = ({ isOpen, onClose }: LoginModalProps) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative overflow-hidden bg-graphite-deep rounded-2xl shadow-2xl w-full max-w-md animate-scale-in">
        ...
        <div className="relative bg-gradient-to-br from-neon-iris/10 to-graphite-deep px-6 py-8 border-b border-white/[0.04]">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 p-2 text-gray-400 hover:text-white hover:bg-dark-800 rounded-lg transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-dark-900 text-sm text-gray-500">
                or continue with
              </span>
            </div>
          </div>
