...
export const Footer = () => {
  ...
  return (
    <footer className="w-full bg-graphite-deep border-t border-white/5">
      <div className="section-container py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <Link
              to="/how-it-works"
              className="text-moon-grey hover:text-white text-sm transition-colors duration-200"
            >
              How it Works
            </Link>
            <Link
          ...
          {/* Right: Copyright */}
          <div className="text-moon-grey-dark text-sm">
